...
//   const captureVideoFrame = (videoElement, timePosition = null) => {
...
//       console.log("🎬 SSE 비디오 알림 받음!", event.detail);

//       // 비디오 URL 추출
//       if (event.detail.payload && event.detail.payload.imageUrl) {
//         const videoUrl = Array.isArray(event.detail.payload.imageUrl)
//           ? event.detail.payload.imageUrl[0]
//           : event.detail.payload.imageUrl;
