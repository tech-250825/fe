...
import { Home, Compass, Image as ImageIcon, Video, User, ArrowRight, Play, Search, Menu } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentBannerTextIndex((prevIndex) => (prevIndex + 1) % bannerTexts.length);
  ...
  return (
    <div className="flex min-h-screen bg-white text-black font-sans">
      ...
      <aside className="w-64 bg-white p-6 flex flex-col shadow-lg border-r border-gray-200">
        ...
        <nav className="mb-10">
          <ul className="space-y-4">
            <li>
              <a href="#" className="flex items-center space-x-4 text-lg text-gray-700 hover:text-black transition-colors duration-200">
        ...
        {/* Tools Section */}
        <div className="mb-10">
          <h3 className="text-xs uppercase tracking-widest text-gray-500 mb-5">TOOLS</h3>
          <ul className="space-y-4">
            <li>
              <a href="#" className="flex items-center space-x-4 text-lg text-gray-700 hover:text-black transition-colors duration-200">
        ...
        <div className="mt-auto">
          <div className="flex items-center space-x-4 p-4 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors duration-200 cursor-pointer">
            <div className="w-12 h-12 rounded-full bg-gray-300 flex items-center justify-center text-xl font-bold text-gray-700">MA</div>
            <div>
      ...
      <div className="flex-1 p-10 overflow-y-auto bg-gray-50">
        ...
        {/* Video Grid */}
        <section>
          <h3 className="text-3xl font-bold mb-8 text-black">Explore Animations</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {Array.from({ length: 8 }).map((_, index) => (
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group border border-gray-200">
                ...
                <div className="p-5">
                  <h4 className="font-semibold text-xl mb-2 text-black">Awesome Animation {index + 1}</h4>
